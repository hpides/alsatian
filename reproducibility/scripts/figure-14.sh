...
mkdir -p /mount-fs/plots/fig14/2000
mkdir -p /mount-fs/plots/fig14/8000
cd /mount-fs/plots/fig14/

# Assigning command line arguments to variables
repository_url=https://github.com/hpides/alsatian.git
script_to_start=experiments/main_experiments/model_search/eval/hf_snapshots_load_all/plot_hf_single_architectures_subset_two_legends.py
