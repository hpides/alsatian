...
class TestTensorCachingService(unittest.TestCase):
    def setUp(self):
        ...
        self.snapshot1 = RichModelSnapshot("test_arch1", "sd_path1", "sd_hash1", self.model_1_layer_states)
        ...
        self.snapshot2 = RichModelSnapshot("test_arch2", "sd_path2", "sd_hash2", self.model_2_layer_states)
        ...
        self.snapshot3 = RichModelSnapshot("test_arch3", "sd_path3", "sd_hash3", self.model_3_layer_states)
        ...
        self.snapshot4 = RichModelSnapshot("test_arch4", "sd_path4", "sd_hash4", self.model_4_layer_states)
    ...
    def test_add_same_snapshot_twice(self):
        ...
        snapshot = RichModelSnapshot("test_arch2", "sd_path2", "sd_hash2", self.model_1_layer_states)
