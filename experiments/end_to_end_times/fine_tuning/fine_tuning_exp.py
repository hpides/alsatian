...
from experiments.end_to_end_times.fine_tuning.train_model import standard_training
...
def fine_tuning(args, model):
    ...
    write_measurements_and_args_to_json_file(
        ...
        file_id=f'env_name-{args.env_name}-model_name-{args.model_name}-fine_tuning_variant-{args.fine_tuning_variant}-train_size-{args.train_size}-val_size-{args.val_size}'
    )
