...
if __name__ == "__main__":
    ...
    parser.add_argument('--base_config_section', default='debug-des-gpu-out-of-memory-5gb')
    ...
    eval_space = {
        ...
        APPROACHES: ["shift", "mosix"],
        NUM_WORKERS: [4, 8, 12],  # first entry baseline, second shift, third mosix
