...
if __name__ == '__main__':
    file_template = 'des-gpu-imagenette-huggingface-res50-approach-{}-cache-CPU-snapshot-{}-models-50-items-{}-level-{}'
    ...
    for data_items in [2000, 8000]:
        root_dir = os.path.abspath('./results/des-gpu-imagenette-huggingface-res50')
