...
if __name__ == '__main__':
    ...
    file_template = 'des-gpu-imagenette-huggingface-single-architecture-search#approach#{}#cache#CPU#snapshot#{}#models#-1#items#{}#level#{}'

    model_sets = {
        "long": ([GOOGLE_VIT_BASE_PATCH16_224_IN21K, FACEBOOK_DETR_RESNET_50], 5),
        "medium": ([CONDITIONAL_DETR_RESNET_50, FACEBOOK_DINOV2_BASE, FACEBOOK_DINOV2_LARGE], 6),
        "short": ([MICROSOFT_RESNET_18, MICROSOFT_RESNET_152, MICROSOFT_TABLE_STRUCTURE_RECOGNITION,
                   MICROSOFT_TABLE_TRANSFORMER_DETECTION, FACEBOOK_DETR_RESNET_101, FACEBOOK_DETR_RESNET_50_DC5,
                   SENSE_TIME_DEFORMABLE_DETR], 14)
    }
    for set_key, (models, plot_width) in model_sets.items():
        ...
        for data_items in [2000, 8000]:
            root_dir = os.path.abspath('./results/des-gpu-imagenette-huggingface-single-architecture-search')
